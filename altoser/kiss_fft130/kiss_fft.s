...
# --param l2-cache-size=1024 -mtune=generic -march=x86-64 -O3 -ffast-math
...
# PRED: ENTRY [100.0%]  (FALLTHRU)
	...
	movss	4(%r8), %xmm1	# MEM[(struct kiss_fft_cpx *)_15 + 4B], ya$i
	movss	(%r8), %xmm14	# MEM[(struct kiss_fft_cpx *)_15], ya$r
	leaq	(%rdi,%r9), %r8	#, Fout1
	movss	%xmm1, -4(%rsp)	# ya$i, %sfp
	leaq	(%r8,%r9), %r10	#, Fout2
	movss	(%rax), %xmm1	# MEM[(struct kiss_fft_cpx *)_18], yb$r
	movss	%xmm1, -8(%rsp)	# yb$r, %sfp
	leaq	(%r10,%r9), %r11	#, Fout3
	movss	4(%rax), %xmm1	# MEM[(struct kiss_fft_cpx *)_18 + 4B], yb$i
	movss	%xmm1, -12(%rsp)	# yb$i, %sfp
...
.L3:
	...
	addq	$8, %r8	#, Fout1
	addq	$8, %rdi	#, Fout
	movaps	%xmm0, %xmm5	# D.5563, D.5563
	addq	$8, %r10	#, Fout2
	movss	-8(%r8), %xmm4	# MEM[base: Fout1_168, offset: 0B], D.5563
	addq	$8, %r11	#, Fout3
	movss	4(%rdx,%rax), %xmm3	# MEM[base: twiddles_9, index: ivtmp.92_121, offset: 4B], D.5563
	addq	$8, %r9	#, Fout4
	mulss	%xmm3, %xmm5	# D.5563, D.5563
	movaps	%xmm4, %xmm1	# D.5563, D.5563
	mulss	%xmm4, %xmm3	# D.5563, D.5563
	movss	(%rdx,%rax), %xmm2	# MEM[base: twiddles_9, index: ivtmp.92_121, offset: 0B], D.5563
	mulss	%xmm2, %xmm0	# D.5563, D.5563
	movss	-8(%r10), %xmm6	# MEM[base: Fout2_173, offset: 0B], D.5563
	mulss	%xmm2, %xmm1	# D.5563, D.5563
	movss	4(%rdx,%rax,2), %xmm4	# MEM[base: twiddles_9, index: ivtmp.92_121, step: 2, offset: 4B], D.5563
	movss	-8(%r11), %xmm9	# MEM[base: Fout3_175, offset: 0B], D.5563
	movaps	%xmm3, %xmm2	# D.5563, D.5563
	movss	-4(%r10), %xmm3	# MEM[base: Fout2_173, offset: 4B], D.5563
	movaps	%xmm3, %xmm7	# D.5563, D.5563
	addss	%xmm0, %xmm2	# D.5563, D.5563
	movss	(%rdx,%rax,2), %xmm0	# MEM[base: twiddles_9, index: ivtmp.92_121, step: 2, offset: 0B], D.5563
	mulss	%xmm4, %xmm7	# D.5563, D.5563
	subss	%xmm5, %xmm1	# D.5563, D.5563
	mulss	%xmm6, %xmm4	# D.5563, D.5563
	movaps	%xmm6, %xmm5	# D.5563, D.5563
	mulss	%xmm0, %xmm3	# D.5563, D.5563
	movss	(%rsi), %xmm6	# MEM[base: _358, offset: 0B], D.5563
	mulss	%xmm0, %xmm5	# D.5563, D.5563
	movss	-8(%r9), %xmm12	# MEM[base: Fout4_174, offset: 0B], D.5563
	movss	-8(%rdi), %xmm10	# MEM[base: Fout_169, offset: 0B], scratch$0$r
	movaps	%xmm4, %xmm0	# D.5563, D.5563
	movss	4(%rsi), %xmm4	# MEM[base: _358, offset: 4B], D.5563
	movss	-4(%rdi), %xmm8	# MEM[base: Fout_169, offset: 4B], scratch$0$i
	addq	%rbx, %rsi	# tmp222, ivtmp.99
	addss	%xmm3, %xmm0	# D.5563, D.5563
	movss	-4(%r11), %xmm3	# MEM[base: Fout3_175, offset: 4B], D.5563
	movaps	%xmm3, %xmm11	# D.5563, D.5563
	mulss	%xmm6, %xmm3	# D.5563, D.5563
	subss	%xmm7, %xmm5	# D.5563, D.5563
	movaps	%xmm9, %xmm7	# D.5563, D.5563
	mulss	%xmm4, %xmm11	# D.5563, D.5563
	movss	-8(%rsp), %xmm15	# %sfp, yb$r
	mulss	%xmm9, %xmm4	# D.5563, D.5563
	movss	4(%rdx,%rax,4), %xmm9	# MEM[base: twiddles_9, index: ivtmp.92_121, step: 4, offset: 4B], D.5563
	mulss	%xmm6, %xmm7	# D.5563, D.5563
	addss	%xmm3, %xmm4	# D.5563, D.5563
	movss	-4(%r9), %xmm3	# MEM[base: Fout4_174, offset: 4B], D.5563
	movaps	%xmm3, %xmm13	# D.5563, D.5563
	subss	%xmm11, %xmm7	# D.5563, D.5563
	movss	(%rdx,%rax,4), %xmm11	# MEM[base: twiddles_9, index: ivtmp.92_121, step: 4, offset: 0B], D.5563
	mulss	%xmm9, %xmm13	# D.5563, D.5563
	addq	%rbp, %rax	# D.5564, ivtmp.92
	movaps	%xmm4, %xmm6	# D.5563, D.5563
	movaps	%xmm12, %xmm4	# D.5563, D.5563
	mulss	%xmm12, %xmm9	# D.5563, D.5563
	mulss	%xmm11, %xmm4	# D.5563, D.5563
	mulss	%xmm11, %xmm3	# D.5563, D.5563
	movaps	%xmm1, %xmm11	# D.5563, D.5563
	subss	%xmm13, %xmm4	# D.5563, D.5563
	addss	%xmm9, %xmm3	# D.5563, D.5563
	movaps	%xmm2, %xmm9	# D.5563, D.5563
	addss	%xmm4, %xmm11	# D.5563, D.5563
	addss	%xmm3, %xmm9	# D.5563, D.5563
	subss	%xmm3, %xmm2	# D.5563, D.5563
	movaps	%xmm0, %xmm3	# D.5563, D.5563
	subss	%xmm4, %xmm1	# D.5563, D.5563
	movaps	%xmm5, %xmm4	# D.5563, D.5563
	addss	%xmm6, %xmm3	# D.5563, D.5563
	movaps	%xmm11, %xmm13	# D.5563, D.5563
	subss	%xmm6, %xmm0	# D.5563, D.5563
	movaps	%xmm11, %xmm6	# D.5563, D.5563
	addss	%xmm7, %xmm4	# D.5563, D.5563
	mulss	%xmm14, %xmm13	# ya$r, D.5563
	addss	%xmm10, %xmm6	# scratch$0$r, D.5563
	subss	%xmm7, %xmm5	# D.5563, D.5563
	movaps	%xmm15, %xmm7	# yb$r, D.5563
	addss	%xmm10, %xmm13	# scratch$0$r, D.5563
	mulss	%xmm4, %xmm7	# D.5563, D.5563
	addss	%xmm4, %xmm6	# D.5563, D.5563
	mulss	%xmm14, %xmm4	# ya$r, D.5563
	addss	%xmm7, %xmm13	# D.5563, D.5563
	movaps	%xmm15, %xmm7	# yb$r, D.5563
	movss	%xmm6, -8(%rdi)	# D.5563, MEM[base: Fout_169, offset: 0B]
	movaps	%xmm9, %xmm6	# D.5563, D.5563
	mulss	%xmm3, %xmm7	# D.5563, D.5563
	movss	-4(%rsp), %xmm15	# %sfp, ya$i
	addss	%xmm8, %xmm6	# scratch$0$i, D.5563
	movaps	%xmm15, %xmm12	# ya$i, D.5563
	mulss	%xmm1, %xmm15	# D.5563, D.5563
	mulss	%xmm2, %xmm12	# D.5563, D.5563
	addss	%xmm3, %xmm6	# D.5563, D.5563
	mulss	%xmm14, %xmm3	# ya$r, D.5563
	movss	%xmm6, -4(%rdi)	# D.5563, MEM[base: Fout_169, offset: 4B]
	movaps	%xmm9, %xmm6	# D.5563, D.5563
	mulss	%xmm14, %xmm6	# ya$r, D.5563
	addss	%xmm8, %xmm6	# scratch$0$i, D.5563
	addss	%xmm7, %xmm6	# D.5563, D.5563
	movss	-12(%rsp), %xmm7	# %sfp, D.5563
	mulss	%xmm0, %xmm7	# D.5563, D.5563
	addss	%xmm12, %xmm7	# D.5563, D.5563
	movss	-12(%rsp), %xmm12	# %sfp, D.5563
	mulss	%xmm5, %xmm12	# D.5563, D.5563
	addss	%xmm15, %xmm12	# D.5563, D.5563
	movaps	%xmm13, %xmm15	# D.5563, D.5563
	subss	%xmm7, %xmm15	# D.5563, D.5563
	addss	%xmm13, %xmm7	# D.5563, D.5563
	movss	%xmm15, -8(%r8)	# D.5563, MEM[base: Fout1_168, offset: 0B]
	movaps	%xmm12, %xmm15	# D.5563, D.5563
	addss	%xmm6, %xmm15	# D.5563, D.5563
	subss	%xmm12, %xmm6	# D.5563, D.5563
	movss	-12(%rsp), %xmm12	# %sfp, yb$i
	mulss	%xmm12, %xmm2	# yb$i, D.5563
	mulss	%xmm12, %xmm1	# yb$i, D.5563
	movss	%xmm15, -4(%r8)	# D.5563, MEM[base: Fout1_168, offset: 4B]
	movss	%xmm7, -8(%r9)	# D.5563, MEM[base: Fout4_174, offset: 0B]
	movss	-8(%rsp), %xmm7	# %sfp, yb$r
	mulss	%xmm7, %xmm11	# yb$r, D.5563
	movss	-4(%rsp), %xmm15	# %sfp, ya$i
	mulss	%xmm7, %xmm9	# yb$r, D.5563
	movss	%xmm6, -4(%r9)	# D.5563, MEM[base: Fout4_174, offset: 4B]
	mulss	%xmm15, %xmm0	# ya$i, D.5563
	mulss	%xmm15, %xmm5	# ya$i, D.5563
	addss	%xmm11, %xmm10	# D.5563, D.5563
	addss	%xmm9, %xmm8	# D.5563, D.5563
	subss	%xmm2, %xmm0	# D.5563, D.5563
	subss	%xmm5, %xmm1	# D.5563, D.5563
	addss	%xmm4, %xmm10	# D.5563, D.5563
	addss	%xmm3, %xmm8	# D.5563, D.5563
	movaps	%xmm10, %xmm2	# D.5563, D.5563
	subss	%xmm0, %xmm10	# D.5563, D.5563
	addss	%xmm0, %xmm2	# D.5563, D.5563
	movss	%xmm2, -8(%r10)	# D.5563, MEM[base: Fout2_173, offset: 0B]
	movaps	%xmm8, %xmm2	# D.5563, D.5563
	subss	%xmm1, %xmm8	# D.5563, D.5563
	addss	%xmm1, %xmm2	# D.5563, D.5563
	movss	%xmm2, -4(%r10)	# D.5563, MEM[base: Fout2_173, offset: 4B]
	movss	%xmm10, -8(%r11)	# D.5563, MEM[base: Fout3_175, offset: 0B]
	movss	%xmm8, -4(%r11)	# D.5563, MEM[base: Fout3_175, offset: 4B]
...
.L35:
	...
	movq	%rdi, %r9	# tw3, tw3
	movq	%rdi, %r8	# tw3, tw3
	leaq	(%rax,%rax,2), %r11	#, tmp339
	movq	%rax, %rbp	# fstride, D.5723
...
.L52:
	...
	addss	%xmm9, %xmm5	# D.5724, D.5724
	movss	%xmm0, (%rsi)	# D.5724, MEM[base: _494, offset: 0B]
	movaps	%xmm10, %xmm0	# D.5724, D.5724
	subss	%xmm6, %xmm10	# D.5724, D.5724
	addss	%xmm6, %xmm0	# D.5724, D.5724
	movss	%xmm0, 4(%rsi)	# D.5724, MEM[base: _494, offset: 4B]
	movss	%xmm5, (%rdx)	# D.5724, MEM[base: _490, offset: 0B]
# SUCC: 12 [100.0%]  (FALLTHRU,CAN_FALLTHRU)
	movss	%xmm10, 4(%rdx)	# D.5724, MEM[base: _490, offset: 4B]
...
.L43:
	...
	movss	4(%r15), %xmm2	# MEM[base: Fout_152, offset: 4B], D.5724
	mulss	%xmm0, %xmm9	# D.5724, D.5724
	mulss	%xmm3, %xmm0	# D.5724, D.5724
	movaps	%xmm2, %xmm10	# D.5724, D.5724
	addq	%r11, %r9	# tmp340, tw3
	testl	%ebx, %ebx	# D.5722
	subss	%xmm4, %xmm10	# D.5724, D.5724
	addss	%xmm2, %xmm4	# D.5724, D.5724
	movaps	%xmm5, %xmm2	# D.5724, D.5724
	addss	%xmm1, %xmm0	# D.5724, D.5724
	movss	(%r15), %xmm1	# MEM[base: Fout_152, offset: 0B], D.5724
	subss	%xmm9, %xmm8	# D.5724, D.5724
	movaps	%xmm1, %xmm9	# D.5724, D.5724
	movss	%xmm4, 4(%r15)	# D.5724, MEM[base: Fout_152, offset: 4B]
	subss	%xmm7, %xmm9	# D.5724, D.5724
	addss	%xmm1, %xmm7	# D.5724, D.5724
	movaps	%xmm4, %xmm1	# D.5724, D.5724
	movaps	%xmm6, %xmm4	# D.5724, D.5724
	addss	%xmm0, %xmm2	# D.5724, D.5724
	addss	%xmm8, %xmm4	# D.5724, D.5724
	movaps	%xmm7, %xmm3	# D.5724, D.5724
	movss	%xmm7, (%r15)	# D.5724, MEM[base: Fout_152, offset: 0B]
	subss	%xmm0, %xmm5	# D.5724, D.5724
	movaps	%xmm9, %xmm0	# D.5724, D.5724
	subss	%xmm2, %xmm1	# D.5724, D.5724
	subss	%xmm4, %xmm3	# D.5724, D.5724
	subss	%xmm8, %xmm6	# D.5724, D.5724
	movss	%xmm1, 4(%rcx)	# D.5724, MEM[base: _492, offset: 4B]
	movss	%xmm3, (%rcx)	# D.5724, MEM[base: _492, offset: 0B]
	addss	(%r15), %xmm4	# MEM[base: Fout_152, offset: 0B], D.5724
	addss	4(%r15), %xmm2	# MEM[base: Fout_152, offset: 4B], D.5724
	movss	%xmm4, (%r15)	# D.5724, MEM[base: Fout_152, offset: 0B]
	movss	%xmm2, 4(%r15)	# D.5724, MEM[base: Fout_152, offset: 4B]
...
# PRED: 13 [50.0%]  (FALLTHRU,CAN_FALLTHRU)
	...
	subss	%xmm5, %xmm9	# D.5724, D.5724
	movss	%xmm0, (%rsi)	# D.5724, MEM[base: _494, offset: 0B]
	movaps	%xmm10, %xmm0	# D.5724, D.5724
	subss	%xmm6, %xmm0	# D.5724, D.5724
	addss	%xmm10, %xmm6	# D.5724, D.5724
	movss	%xmm0, 4(%rsi)	# D.5724, MEM[base: _494, offset: 4B]
	movss	%xmm9, (%rdx)	# D.5724, MEM[base: _490, offset: 0B]
...
.L111:
	...
	addss	%xmm9, %xmm5	# D.5908, D.5908
	movss	%xmm0, (%rcx)	# D.5908, MEM[base: _601, offset: 0B]
	movaps	%xmm10, %xmm0	# D.5908, D.5908
	subss	%xmm6, %xmm10	# D.5908, D.5908
	addss	%xmm6, %xmm0	# D.5908, D.5908
	movss	%xmm0, 4(%rcx)	# D.5908, MEM[base: _601, offset: 4B]
	movss	%xmm5, (%rax)	# D.5908, MEM[base: _605, offset: 0B]
# SUCC: 12 [100.0%]  (FALLTHRU,CAN_FALLTHRU)
	movss	%xmm10, 4(%rax)	# D.5908, MEM[base: _605, offset: 4B]
# BLOCK 12 freq:2778 seq:10
# PRED: 11 [100.0%]  (FALLTHRU,CAN_FALLTHRU) 14 [100.0%]  (CAN_FALLTHRU)
.L77:
	addq	$8, %r14	#, Fout
...
.L78:
	...
	movss	4(%r14), %xmm2	# MEM[base: Fout_151, offset: 4B], D.5908
	mulss	%xmm0, %xmm9	# D.5908, D.5908
	mulss	%xmm3, %xmm0	# D.5908, D.5908
	movaps	%xmm2, %xmm10	# D.5908, D.5908
	testl	%r11d, %r11d	# D.5906
	subss	%xmm4, %xmm10	# D.5908, D.5908
	addss	%xmm2, %xmm4	# D.5908, D.5908
	movaps	%xmm5, %xmm2	# D.5908, D.5908
	addss	%xmm1, %xmm0	# D.5908, D.5908
	movss	(%r14), %xmm1	# MEM[base: Fout_151, offset: 0B], D.5908
	subss	%xmm9, %xmm8	# D.5908, D.5908
	movaps	%xmm1, %xmm9	# D.5908, D.5908
	movss	%xmm4, 4(%r14)	# D.5908, MEM[base: Fout_151, offset: 4B]
	subss	%xmm7, %xmm9	# D.5908, D.5908
	addss	%xmm1, %xmm7	# D.5908, D.5908
	movaps	%xmm4, %xmm1	# D.5908, D.5908
	movaps	%xmm6, %xmm4	# D.5908, D.5908
	addss	%xmm0, %xmm2	# D.5908, D.5908
	addss	%xmm8, %xmm4	# D.5908, D.5908
	movaps	%xmm7, %xmm3	# D.5908, D.5908
	...
	subss	%xmm4, %xmm3	# D.5908, D.5908
	subss	%xmm8, %xmm6	# D.5908, D.5908
	movss	%xmm1, 4(%rdx)	# D.5908, MEM[base: _603, offset: 4B]
	movss	%xmm3, (%rdx)	# D.5908, MEM[base: _603, offset: 0B]
	addss	(%r14), %xmm4	# MEM[base: Fout_151, offset: 0B], D.5908
	addss	4(%r14), %xmm2	# MEM[base: Fout_151, offset: 4B], D.5908
	movss	%xmm4, (%r14)	# D.5908, MEM[base: Fout_151, offset: 0B]
	movss	%xmm2, 4(%r14)	# D.5908, MEM[base: Fout_151, offset: 4B]
# SUCC: 11 [50.0%]  (CAN_FALLTHRU) 14 [50.0%]  (FALLTHRU,CAN_FALLTHRU)
	jne	.L111	#,
# BLOCK 14 freq:1389 seq:12
# PRED: 13 [50.0%]  (FALLTHRU,CAN_FALLTHRU)
	addss	%xmm5, %xmm0	# D.5908, D.5908
	subss	%xmm5, %xmm9	# D.5908, D.5908
	movss	%xmm0, (%rcx)	# D.5908, MEM[base: _601, offset: 0B]
	movaps	%xmm10, %xmm0	# D.5908, D.5908
	subss	%xmm6, %xmm0	# D.5908, D.5908
	addss	%xmm10, %xmm6	# D.5908, D.5908
	movss	%xmm0, 4(%rcx)	# D.5908, MEM[base: _601, offset: 4B]
	movss	%xmm9, (%rax)	# D.5908, MEM[base: _605, offset: 0B]
...
# PRED: 2 [89.9%]  (FALLTHRU,CAN_FALLTHRU)
	...
	movl	%eax, %edx	# p, D.6352
	movl	%eax, 16(%rsp)	# p, %sfp
	movl	%edi, 28(%rsp)	# m, %sfp
	imull	%edi, %edx	# m, D.6352
	cmpl	$1, %edi	#, m
	movslq	%edx, %rdx	# D.6352, D.6353
	leaq	(%r15,%rdx,8), %r12	#, Fout_end
...
# PRED: 11 [66.7%]  (FALLTHRU,CAN_FALLTHRU)
	movslq	28(%rsp), %rsi	# %sfp,
	leaq	264(%rbx), %rcx	#, tw1
	leaq	32(%r15), %r12	#, D.6357
	leaq	296(%rbx), %r11	#, D.6364
	movq	%rsi, %rax	#,
	salq	$3, %rsi	#, D.6353
	leaq	(%r15,%rsi), %rdx	#, Fout2
	addq	$32, %rsi	#, D.6353
	movl	%eax, %r9d	# m, D.6355
	leaq	(%r15,%rsi), %rdi	#, D.6357
	cmpq	%rdi, %rcx	# D.6357, tw1
	setnb	%dil	#, tmp1074
	cmpq	%rcx, %r12	# tw1, D.6357
	setbe	%r10b	#, D.6356
	cmpq	%r11, %r15	# D.6364, fout
	setnb	%r8b	#, D.6356
	orl	%r10d, %r8d	# D.6356, D.6356
	cmpl	$3, %eax	#, m
	seta	%r10b	#, D.6356
	andl	%r10d, %r8d	# D.6356, D.6356
	cmpq	%r11, %rdx	# D.6364, Fout2
	setnb	%r10b	#, D.6356
	orl	%r10d, %edi	# D.6356, D.6356
	testb	%dil, %r8b	# D.6356, D.6356
# SUCC: 54 [10.0%]  (CAN_FALLTHRU) 13 [90.0%]  (FALLTHRU,CAN_FALLTHRU)
	je	.L250	#,
# BLOCK 13 freq:225 seq:11
# PRED: 12 [90.0%]  (FALLTHRU,CAN_FALLTHRU)
	testq	%rsi, %rsi	# D.6353
	setle	%dil	#, D.6356
	cmpq	%r12, %rdx	# D.6357, Fout2
	setnb	%sil	#, D.6356
	orb	%sil, %dil	# D.6356, tmp1365
# SUCC: 54 [11.1%]  (CAN_FALLTHRU) 14 [88.9%]  (FALLTHRU,CAN_FALLTHRU)
	je	.L250	#,
# BLOCK 14 freq:200 seq:12
# PRED: 13 [88.9%]  (FALLTHRU,CAN_FALLTHRU)
	leal	-5(%rax), %r8d	#, D.6355
	leal	-1(%rax), %esi	#, m
	shrl	$2, %r8d	#, D.6355
	addl	$1, %r8d	#, bnd.419
	cmpl	$3, %esi	#, m
	leal	0(,%r8,4), %r11d	#, ratio_mult_vf.420
# SUCC: 15 [66.7%]  (FALLTHRU,CAN_FALLTHRU) 19 [33.3%]  (CAN_FALLTHRU)
	jbe	.L251	#,
# BLOCK 15 freq:133 seq:13
# PRED: 14 [66.7%]  (FALLTHRU,CAN_FALLTHRU)
	movq	%r15, %rdi	# fout, ivtmp.561
	xorl	%esi, %esi	# ivtmp.560
# SUCC: 16 [100.0%]  (FALLTHRU,CAN_FALLTHRU)
	xorl	%r10d, %r10d	# ivtmp.556
# BLOCK 16 freq:267 seq:14
# PRED: 15 [100.0%]  (FALLTHRU,CAN_FALLTHRU) 16 [50.0%]  (DFS_BACK,CAN_FALLTHRU)
.L252:
	movups	(%rdx,%rsi), %xmm4	# MEM[base: Fout2_257, index: ivtmp.560_1170, offset: 0B], tmp1096
	addl	$1, %r10d	#, ivtmp.556
	addq	$32, %rdi	#, ivtmp.561
	movups	16(%rdx,%rsi), %xmm0	# MEM[base: Fout2_257, index: ivtmp.560_1170, offset: 16B], tmp1097
	movaps	%xmm4, %xmm2	# tmp1096, D.6360
	movups	264(%rbx,%rsi), %xmm3	# MEM[base: cfg_2(D), index: ivtmp.560_1170, offset: 264B], tmp1098
	shufps	$221, %xmm0, %xmm4	#, tmp1097, D.6360
	movups	280(%rbx,%rsi), %xmm1	# MEM[base: cfg_2(D), index: ivtmp.560_1170, offset: 280B], tmp1099
	...
	movups	-16(%rdi), %xmm4	# MEM[base: _1175, offset: 16B], tmp1105
	...
	movups	-32(%rdi), %xmm0	# MEM[base: _1175, offset: 0B], tmp1104
	...
	movups	%xmm6, (%rdx,%rsi)	# D.6360, MEM[base: Fout2_257, index: ivtmp.560_1170, offset: 0B]
	movups	%xmm3, 16(%rdx,%rsi)	# D.6360, MEM[base: Fout2_257, index: ivtmp.560_1170, offset: 16B]
	addq	$32, %rsi	#, ivtmp.560
	movups	%xmm1, -32(%rdi)	# D.6360, MEM[base: _1175, offset: 0B]
	movups	%xmm2, -16(%rdi)	# D.6360, MEM[base: _1175, offset: 16B]
	cmpl	%r10d, %r8d	# ivtmp.556, bnd.419
...
# PRED: 16 [50.0%]  (FALLTHRU,CAN_FALLTHRU,LOOP_EXIT)
	movl	%r11d, %esi	# ratio_mult_vf.420, D.6358
	salq	$3, %rsi	#, D.6358
	subl	%r11d, 28(%rsp)	# ratio_mult_vf.420, %sfp
	addq	%rsi, %r15	# D.6358, fout
	addq	%rsi, %rdx	# D.6358, Fout2
	addq	%rsi, %rcx	# D.6358, tw1
	cmpl	%r9d, %r11d	# D.6355, ratio_mult_vf.420
	movl	28(%rsp), %eax	# %sfp, m
...
.L251:
	movss	(%rdx), %xmm4	# Fout2_644->r, D.6354
	testl	%esi, %esi	# m
	movss	4(%rdx), %xmm1	# Fout2_644->i, D.6354
	movaps	%xmm4, %xmm2	# D.6354, D.6354
	movaps	%xmm1, %xmm5	# D.6354, D.6354
	movss	(%rcx), %xmm0	# tw1_642->r, D.6354
	movss	4(%rcx), %xmm3	# tw1_642->i, D.6354
...
# PRED: 19 [75.0%]  (FALLTHRU,CAN_FALLTHRU)
	movss	8(%rdx), %xmm4	# MEM[(struct kiss_fft_cpx *)Fout2_644 + 8B].r, D.6354
	movl	28(%rsp), %eax	# %sfp, m
	movss	12(%rdx), %xmm1	# MEM[(struct kiss_fft_cpx *)Fout2_644 + 8B].i, D.6354
	movaps	%xmm4, %xmm2	# D.6354, D.6354
	movaps	%xmm1, %xmm5	# D.6354, D.6354
	movss	8(%rcx), %xmm0	# MEM[(struct kiss_fft_cpx *)tw1_642 + 8B].r, D.6354
	cmpl	$2, %eax	#, m
	movss	12(%rcx), %xmm3	# MEM[(struct kiss_fft_cpx *)tw1_642 + 8B].i, D.6354
	mulss	%xmm0, %xmm2	# D.6354, D.6354
	mulss	%xmm3, %xmm5	# D.6354, D.6354
	mulss	%xmm0, %xmm1	# D.6354, D.6354
	mulss	%xmm4, %xmm3	# D.6354, D.6354
	...
	subss	%xmm2, %xmm1	# D.6354, D.6354
	movaps	%xmm3, %xmm0	# D.6354, D.6354
	movss	%xmm1, 8(%rdx)	# D.6354, MEM[(struct kiss_fft_cpx *)Fout2_644 + 8B].r
	...
	movss	%xmm1, 12(%rdx)	# D.6354, MEM[(struct kiss_fft_cpx *)Fout2_644 + 8B].i
...
# PRED: 20 [75.0%]  (FALLTHRU,CAN_FALLTHRU)
	movss	16(%rdx), %xmm4	# MEM[(struct kiss_fft_cpx *)Fout2_644 + 16B].r, D.6354
	cmpl	$3, %eax	#, m
	movss	20(%rdx), %xmm1	# MEM[(struct kiss_fft_cpx *)Fout2_644 + 16B].i, D.6354
	movaps	%xmm4, %xmm2	# D.6354, D.6354
	movaps	%xmm1, %xmm5	# D.6354, D.6354
	movss	16(%rcx), %xmm0	# MEM[(struct kiss_fft_cpx *)tw1_642 + 16B].r, D.6354
	movss	20(%rcx), %xmm3	# MEM[(struct kiss_fft_cpx *)tw1_642 + 16B].i, D.6354
	mulss	%xmm0, %xmm2	# D.6354, D.6354
	mulss	%xmm3, %xmm5	# D.6354, D.6354
	mulss	%xmm0, %xmm1	# D.6354, D.6354
	mulss	%xmm4, %xmm3	# D.6354, D.6354
	...
	subss	%xmm2, %xmm1	# D.6354, D.6354
	movaps	%xmm3, %xmm0	# D.6354, D.6354
	movss	%xmm1, 16(%rdx)	# D.6354, MEM[(struct kiss_fft_cpx *)Fout2_644 + 16B].r
	...
	movss	%xmm1, 20(%rdx)	# D.6354, MEM[(struct kiss_fft_cpx *)Fout2_644 + 16B].i
...
# PRED: 21 [75.0%]  (FALLTHRU,CAN_FALLTHRU)
	movss	24(%rdx), %xmm4	# MEM[(struct kiss_fft_cpx *)Fout2_644 + 24B].r, D.6354
	cmpl	$4, %eax	#, m
	movss	28(%rdx), %xmm1	# MEM[(struct kiss_fft_cpx *)Fout2_644 + 24B].i, D.6354
	movaps	%xmm4, %xmm2	# D.6354, D.6354
	movaps	%xmm1, %xmm5	# D.6354, D.6354
	movss	24(%rcx), %xmm0	# MEM[(struct kiss_fft_cpx *)tw1_642 + 24B].r, D.6354
	movss	28(%rcx), %xmm3	# MEM[(struct kiss_fft_cpx *)tw1_642 + 24B].i, D.6354
	mulss	%xmm0, %xmm2	# D.6354, D.6354
	mulss	%xmm3, %xmm5	# D.6354, D.6354
	mulss	%xmm0, %xmm1	# D.6354, D.6354
	mulss	%xmm4, %xmm3	# D.6354, D.6354
	...
	subss	%xmm2, %xmm1	# D.6354, D.6354
	movaps	%xmm3, %xmm0	# D.6354, D.6354
	movss	%xmm1, 24(%rdx)	# D.6354, MEM[(struct kiss_fft_cpx *)Fout2_644 + 24B].r
	...
	movss	%xmm1, 28(%rdx)	# D.6354, MEM[(struct kiss_fft_cpx *)Fout2_644 + 24B].i
...
# PRED: 22 [75.0%]  (FALLTHRU,CAN_FALLTHRU)
	movss	32(%rdx), %xmm4	# MEM[(struct kiss_fft_cpx *)Fout2_644 + 32B].r, D.6354
	cmpl	$5, %eax	#, m
	movss	36(%rdx), %xmm1	# MEM[(struct kiss_fft_cpx *)Fout2_644 + 32B].i, D.6354
	movaps	%xmm4, %xmm2	# D.6354, D.6354
	movaps	%xmm1, %xmm5	# D.6354, D.6354
	movss	32(%rcx), %xmm0	# MEM[(struct kiss_fft_cpx *)tw1_642 + 32B].r, D.6354
	movss	36(%rcx), %xmm3	# MEM[(struct kiss_fft_cpx *)tw1_642 + 32B].i, D.6354
	mulss	%xmm0, %xmm2	# D.6354, D.6354
	mulss	%xmm3, %xmm5	# D.6354, D.6354
	mulss	%xmm0, %xmm1	# D.6354, D.6354
	mulss	%xmm4, %xmm3	# D.6354, D.6354
	...
	subss	%xmm2, %xmm1	# D.6354, D.6354
	movaps	%xmm3, %xmm0	# D.6354, D.6354
	movss	%xmm1, 32(%rdx)	# D.6354, MEM[(struct kiss_fft_cpx *)Fout2_644 + 32B].r
	...
	movss	%xmm1, 36(%rdx)	# D.6354, MEM[(struct kiss_fft_cpx *)Fout2_644 + 32B].i
...
# BLOCK 24 freq:156 seq:22
# PRED: 23 [75.0%]  (FALLTHRU,CAN_FALLTHRU)
	movss	40(%rdx), %xmm4	# MEM[(struct kiss_fft_cpx *)Fout2_644 + 40B].r, D.6354
	cmpl	$6, %eax	#, m
	movss	44(%rdx), %xmm1	# MEM[(struct kiss_fft_cpx *)Fout2_644 + 40B].i, D.6354
	movaps	%xmm4, %xmm2	# D.6354, D.6354
	movaps	%xmm1, %xmm5	# D.6354, D.6354
	movss	40(%rcx), %xmm0	# MEM[(struct kiss_fft_cpx *)tw1_642 + 40B].r, D.6354
	movss	44(%rcx), %xmm3	# MEM[(struct kiss_fft_cpx *)tw1_642 + 40B].i, D.6354
	mulss	%xmm0, %xmm2	# D.6354, D.6354
	mulss	%xmm3, %xmm5	# D.6354, D.6354
	mulss	%xmm0, %xmm1	# D.6354, D.6354
	mulss	%xmm4, %xmm3	# D.6354, D.6354
	...
	subss	%xmm2, %xmm1	# D.6354, D.6354
	movaps	%xmm3, %xmm0	# D.6354, D.6354
	movss	%xmm1, 40(%rdx)	# D.6354, MEM[(struct kiss_fft_cpx *)Fout2_644 + 40B].r
	...
	movss	%xmm1, 44(%rdx)	# D.6354, MEM[(struct kiss_fft_cpx *)Fout2_644 + 40B].i
...
# BLOCK 25 freq:156 seq:23
# PRED: 24 [75.0%]  (FALLTHRU,CAN_FALLTHRU)
	movss	52(%rcx), %xmm0	# MEM[(struct kiss_fft_cpx *)tw1_642 + 48B].i, D.6354
	movss	48(%rcx), %xmm3	# MEM[(struct kiss_fft_cpx *)tw1_642 + 48B].r, D.6354
	movaps	%xmm0, %xmm5	# D.6354, D.6354
	movaps	%xmm3, %xmm2	# D.6354, D.6354
	movss	48(%rdx), %xmm1	# MEM[(struct kiss_fft_cpx *)Fout2_644 + 48B].r, D.6354
	movss	52(%rdx), %xmm4	# MEM[(struct kiss_fft_cpx *)Fout2_644 + 48B].i, D.6354
	...
	subss	%xmm2, %xmm1	# D.6354, D.6354
	movaps	%xmm3, %xmm0	# D.6354, D.6354
	movss	%xmm1, 48(%rdx)	# D.6354, MEM[(struct kiss_fft_cpx *)Fout2_644 + 48B].r
	...
	movss	%xmm1, 52(%rdx)	# D.6354, MEM[(struct kiss_fft_cpx *)Fout2_644 + 48B].i
...
# PRED: 27 [100.0%]  (FALLTHRU,CAN_FALLTHRU) 28 [91.0%]  (DFS_BACK,CAN_FALLTHRU)
	...
	.p2align 3
.L241:
	movq	(%r14), %rax	# MEM[base: fin_230, offset: 0B], MEM[base: fin_230, offset: 0B]
	addq	$8, %rdx	#, fout
	addq	$8, %r14	#, fin
	movq	%rax, -8(%rdx)	# MEM[base: fin_230, offset: 0B], MEM[base: fout_231, offset: 0B]
	cmpq	%rdx, %r12	# fout, Fout_end
...
.L259:
	...
	movss	-16(%rsi), %xmm4	# MEM[base: tw2_307, offset: 0B], D.6354
	mulss	%xmm0, %xmm2	# D.6354, D.6354
	movss	-12(%rsi), %xmm0	# MEM[base: tw2_307, offset: 4B], D.6354
	subss	%xmm5, %xmm1	# D.6354, D.6354
	movss	-8(%rcx), %xmm5	# MEM[base: _576, offset: 0B], D.6354
	addss	%xmm3, %xmm2	# D.6354, D.6354
	movss	-4(%rcx), %xmm3	# MEM[base: _576, offset: 4B], D.6354
	...
	cvtsd2ss	%xmm5, %xmm5	# D.6359, tmp1531
	movss	%xmm5, -8(%rdx)	# tmp1531, MEM[base: _584, offset: 0B]
	pxor	%xmm5, %xmm5	# D.6359
	mulsd	%xmm6, %xmm9	# tmp1277, D.6359
	cvtss2sd	-4(%r15), %xmm5	# MEM[base: fout_291, offset: 4B], D.6359
	subsd	%xmm9, %xmm5	# D.6359, D.6359
	cvtsd2ss	%xmm5, %xmm5	# D.6359, tmp1532
	movss	%xmm5, -4(%rdx)	# tmp1532, MEM[base: _584, offset: 4B]
	...
	movss	-8(%rdx), %xmm2	# MEM[base: _584, offset: 0B], D.6354
	addss	%xmm0, %xmm2	# D.6354, D.6354
	movss	%xmm2, -8(%rcx)	# D.6354, MEM[base: _576, offset: 0B]
	movss	-4(%rdx), %xmm2	# MEM[base: _584, offset: 4B], MEM[base: _584, offset: 4B]
	subss	%xmm1, %xmm2	# D.6354, D.6354
	movss	%xmm2, -4(%rcx)	# D.6354, MEM[base: _576, offset: 4B]
	addss	-4(%rdx), %xmm1	# MEM[base: _584, offset: 4B], D.6354
	movss	-8(%rdx), %xmm2	# MEM[base: _584, offset: 0B], MEM[base: _584, offset: 0B]
	subss	%xmm0, %xmm2	# D.6354, D.6354
	movss	%xmm1, -4(%rdx)	# D.6354, MEM[base: _584, offset: 4B]
	movss	%xmm2, -8(%rdx)	# D.6354, MEM[base: _584, offset: 0B]
	subq	$1, %rbp	#, m
...
.L246:
	...
	leaq	264(%rbx), %rdi	#, tw3
	movl	4(%rbx), %r10d	# cfg_2(D)->inverse, D.6352
	movq	%rdi, %r9	# tw3, tw3
	movq	%rdi, %r8	# tw3, tw3
	leaq	0(,%rbp,8), %rdx	#, D.6353
	leaq	(%r15,%rdx), %rsi	#, ivtmp.609
	leaq	(%rsi,%rdx), %rcx	#, ivtmp.612
	addq	%rcx, %rdx	# ivtmp.612, ivtmp.615
...
.L327:
	...
	addss	%xmm9, %xmm5	# D.6354, D.6354
	movss	%xmm0, (%rsi)	# D.6354, MEM[base: _1193, offset: 0B]
	movaps	%xmm10, %xmm0	# D.6354, D.6354
	subss	%xmm6, %xmm10	# D.6354, D.6354
	addss	%xmm6, %xmm0	# D.6354, D.6354
	movss	%xmm0, 4(%rsi)	# D.6354, MEM[base: _1193, offset: 4B]
	movss	%xmm5, (%rdx)	# D.6354, MEM[base: _1197, offset: 0B]
# SUCC: 36 [100.0%]  (FALLTHRU,CAN_FALLTHRU)
	movss	%xmm10, 4(%rdx)	# D.6354, MEM[base: _1197, offset: 4B]
# BLOCK 36 freq:2778 seq:34
# PRED: 35 [100.0%]  (FALLTHRU,CAN_FALLTHRU) 38 [100.0%]  (CAN_FALLTHRU)
.L262:
	addq	$8, %r15	#, fout
	addq	$8, %rsi	#, ivtmp.609
	addq	$8, %rcx	#, ivtmp.612
	addq	$8, %rdx	#, ivtmp.615
	subq	$1, %rbp	#, k
...
.L263:
	movss	(%rsi), %xmm5	# MEM[base: _1193, offset: 0B], D.6354
	addq	$8, %rdi	#, tw3
	addq	$16, %r8	#, tw3
	movss	4(%rsi), %xmm0	# MEM[base: _1193, offset: 4B], D.6354
	addq	$24, %r9	#, tw3
	movaps	%xmm5, %xmm6	# D.6354, D.6354
	movaps	%xmm0, %xmm3	# D.6354, D.6354
	movss	-8(%rdi), %xmm1	# MEM[base: tw3_361, offset: 0B], D.6354
	movss	-4(%rdi), %xmm2	# MEM[base: tw3_361, offset: 4B], D.6354
	mulss	%xmm1, %xmm0	# D.6354, D.6354
	mulss	%xmm2, %xmm3	# D.6354, D.6354
	movss	(%rcx), %xmm4	# MEM[base: _1195, offset: 0B], D.6354
	mulss	%xmm1, %xmm6	# D.6354, D.6354
	movss	-12(%r8), %xmm1	# MEM[base: tw3_374, offset: 4B], D.6354
	mulss	%xmm2, %xmm5	# D.6354, D.6354
	movss	-16(%r8), %xmm2	# MEM[base: tw3_374, offset: 0B], D.6354
	subss	%xmm3, %xmm6	# D.6354, D.6354
	movaps	%xmm4, %xmm3	# D.6354, D.6354
	addss	%xmm0, %xmm5	# D.6354, D.6354
	movss	4(%rcx), %xmm0	# MEM[base: _1195, offset: 4B], D.6354
	movaps	%xmm0, %xmm8	# D.6354, D.6354
	mulss	%xmm2, %xmm3	# D.6354, D.6354
	mulss	%xmm2, %xmm0	# D.6354, D.6354
	movss	-24(%r9), %xmm2	# MEM[base: tw3_387, offset: 0B], D.6354
	mulss	%xmm1, %xmm8	# D.6354, D.6354
	mulss	%xmm4, %xmm1	# D.6354, D.6354
	movaps	%xmm3, %xmm7	# D.6354, D.6354
	movss	(%rdx), %xmm3	# MEM[base: _1197, offset: 0B], D.6354
	subss	%xmm8, %xmm7	# D.6354, D.6354
	movaps	%xmm3, %xmm8	# D.6354, D.6354
	movaps	%xmm1, %xmm4	# D.6354, D.6354
	movss	4(%rdx), %xmm1	# MEM[base: _1197, offset: 4B], D.6354
	mulss	%xmm2, %xmm8	# D.6354, D.6354
	movaps	%xmm1, %xmm9	# D.6354, D.6354
	mulss	%xmm2, %xmm1	# D.6354, D.6354
	addss	%xmm0, %xmm4	# D.6354, D.6354
	movss	-20(%r9), %xmm0	# MEM[base: tw3_387, offset: 4B], D.6354
	movss	4(%r15), %xmm2	# MEM[base: fout_358, offset: 4B], D.6354
	mulss	%xmm0, %xmm9	# D.6354, D.6354
	mulss	%xmm3, %xmm0	# D.6354, D.6354
	movaps	%xmm2, %xmm10	# D.6354, D.6354
	testl	%r10d, %r10d	# D.6352
	subss	%xmm4, %xmm10	# D.6354, D.6354
	addss	%xmm2, %xmm4	# D.6354, D.6354
	movaps	%xmm5, %xmm2	# D.6354, D.6354
	addss	%xmm1, %xmm0	# D.6354, D.6354
	movss	(%r15), %xmm1	# MEM[base: fout_358, offset: 0B], D.6354
	subss	%xmm9, %xmm8	# D.6354, D.6354
	movaps	%xmm1, %xmm9	# D.6354, D.6354
	movss	%xmm4, 4(%r15)	# D.6354, MEM[base: fout_358, offset: 4B]
	subss	%xmm7, %xmm9	# D.6354, D.6354
	addss	%xmm1, %xmm7	# D.6354, D.6354
	movaps	%xmm4, %xmm1	# D.6354, D.6354
	movaps	%xmm6, %xmm4	# D.6354, D.6354
	addss	%xmm0, %xmm2	# D.6354, D.6354
	addss	%xmm8, %xmm4	# D.6354, D.6354
	movaps	%xmm7, %xmm3	# D.6354, D.6354
	movss	%xmm7, (%r15)	# D.6354, MEM[base: fout_358, offset: 0B]
	subss	%xmm0, %xmm5	# D.6354, D.6354
	movaps	%xmm9, %xmm0	# D.6354, D.6354
	subss	%xmm2, %xmm1	# D.6354, D.6354
	subss	%xmm4, %xmm3	# D.6354, D.6354
	subss	%xmm8, %xmm6	# D.6354, D.6354
	movss	%xmm1, 4(%rcx)	# D.6354, MEM[base: _1195, offset: 4B]
	movss	%xmm3, (%rcx)	# D.6354, MEM[base: _1195, offset: 0B]
	addss	(%r15), %xmm4	# MEM[base: fout_358, offset: 0B], D.6354
	addss	4(%r15), %xmm2	# MEM[base: fout_358, offset: 4B], D.6354
	movss	%xmm4, (%r15)	# D.6354, MEM[base: fout_358, offset: 0B]
	movss	%xmm2, 4(%r15)	# D.6354, MEM[base: fout_358, offset: 4B]
# SUCC: 35 [50.0%]  (CAN_FALLTHRU) 38 [50.0%]  (FALLTHRU,CAN_FALLTHRU)
	jne	.L327	#,
# BLOCK 38 freq:1389 seq:36
# PRED: 37 [50.0%]  (FALLTHRU,CAN_FALLTHRU)
	addss	%xmm5, %xmm0	# D.6354, D.6354
	subss	%xmm5, %xmm9	# D.6354, D.6354
	movss	%xmm0, (%rsi)	# D.6354, MEM[base: _1193, offset: 0B]
	movaps	%xmm10, %xmm0	# D.6354, D.6354
	subss	%xmm6, %xmm0	# D.6354, D.6354
	addss	%xmm10, %xmm6	# D.6354, D.6354
	movss	%xmm0, 4(%rsi)	# D.6354, MEM[base: _1193, offset: 4B]
	movss	%xmm9, (%rdx)	# D.6354, MEM[base: _1197, offset: 0B]
	movss	%xmm6, 4(%rdx)	# D.6354, MEM[base: _1197, offset: 4B]
...
.L323:
	...
	movl	%edi, 28(%rsp)	# p, %sfp
	movl	%esi, 32(%rsp)	# m, %sfp
	imull	%esi, %edi	# m, D.6352
	cmpl	$1, %esi	#, m
	movslq	%edi, %rax	# D.6352,
...
.L330:
	...
	movss	%xmm5, (%rdx)	# D.6354, MEM[base: _1155, offset: 0B]
# SUCC: 51 [100.0%]  (FALLTHRU,CAN_FALLTHRU)
	movss	%xmm10, 4(%rdx)	# D.6354, MEM[base: _1155, offset: 4B]
...
.L239:
	...
	mulss	%xmm2, %xmm5	# D.6354, D.6354
	movss	-16(%r8), %xmm2	# MEM[base: tw3_166, offset: 0B], D.6354
	subss	%xmm3, %xmm6	# D.6354, D.6354
	movaps	%xmm4, %xmm3	# D.6354, D.6354
	addss	%xmm0, %xmm5	# D.6354, D.6354
	...
	movss	4(%rax), %xmm2	# MEM[base: Fout_150, offset: 4B], D.6354
	mulss	%xmm0, %xmm9	# D.6354, D.6354
	mulss	%xmm3, %xmm0	# D.6354, D.6354
	movaps	%xmm2, %xmm10	# D.6354, D.6354
	...
	movaps	%xmm5, %xmm2	# D.6354, D.6354
	addss	%xmm1, %xmm0	# D.6354, D.6354
	movss	(%rax), %xmm1	# MEM[base: Fout_150, offset: 0B], D.6354
	subss	%xmm9, %xmm8	# D.6354, D.6354
	movaps	%xmm1, %xmm9	# D.6354, D.6354
	...
	movss	%xmm3, (%rcx)	# D.6354, MEM[base: _1153, offset: 0B]
	addss	(%rax), %xmm4	# MEM[base: Fout_150, offset: 0B], D.6354
	addss	4(%rax), %xmm2	# MEM[base: Fout_150, offset: 4B], D.6354
	movss	%xmm4, (%rax)	# D.6354, MEM[base: Fout_150, offset: 0B]
	movss	%xmm2, 4(%rax)	# D.6354, MEM[base: Fout_150, offset: 4B]
...
# PRED: 52 [50.0%]  (FALLTHRU,CAN_FALLTHRU)
	...
	addss	%xmm10, %xmm6	# D.6354, D.6354
	movss	%xmm0, 4(%rsi)	# D.6354, MEM[base: _1151, offset: 4B]
	movss	%xmm9, (%rdx)	# D.6354, MEM[base: _1155, offset: 0B]
...
.L250:
	leal	-1(%rax), %esi	#, D.6358
# SUCC: 55 [100.0%]  (FALLTHRU,CAN_FALLTHRU)
	leaq	8(%rcx,%rsi,8), %rsi	#, D.6357
# BLOCK 55 freq:556 seq:53
# PRED: 54 [100.0%]  (FALLTHRU,CAN_FALLTHRU) 55 [91.0%]  (DFS_BACK,CAN_FALLTHRU)
	.p2align 4,,10
	.p2align 3
.L256:
	movss	(%rcx), %xmm0	# MEM[base: tw1_716, offset: 0B], D.6354
	addq	$8, %rcx	#, tw1
	addq	$8, %rdx	#, Fout2
	movss	-4(%rcx), %xmm2	# MEM[base: tw1_716, offset: 4B], D.6354
	addq	$8, %r15	#, fout
	movaps	%xmm0, %xmm4	# D.6354, D.6354
	movaps	%xmm2, %xmm5	# D.6354, D.6354
	movss	-8(%rdx), %xmm1	# MEM[base: Fout2_717, offset: 0B], D.6354
	movss	-4(%rdx), %xmm3	# MEM[base: Fout2_717, offset: 4B], D.6354
	...
	movss	%xmm1, -8(%rdx)	# D.6354, MEM[base: Fout2_717, offset: 0B]
	movss	-4(%r15), %xmm1	# MEM[base: fout_719, offset: 4B], MEM[base: fout_719, offset: 4B]
	subss	%xmm0, %xmm1	# D.6354, D.6354
	movss	%xmm1, -4(%rdx)	# D.6354, MEM[base: Fout2_717, offset: 4B]
